...
export type Photo = {id:string;kind:'photo'|'video'|'audio';filename:string;mime:string;size:number;title:string;note:string;tags:string;takenAt:string;favorite:number;slot:number|null;createdAt:string;revision:number};
