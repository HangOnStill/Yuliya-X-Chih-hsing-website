...
export default function Nicknames({active}:{active:boolean}){
 ...
 return <section>
  <div className="section-top"><div><p className="eyebrow">OUR PRIVATE DICTIONARY · 暱稱賬</p><h2>Only you call me that.</h2><p className="quiet">那些只有彼此懂的稱呼，和一想起來就會笑的瞬間。</p></div><EditButton onClick={()=>setEditing('new')}><Plus size={17}/>Add a nickname · 新增暱稱</EditButton></div>
